"""OpenClaw gateway streaming client for AI chat.
...
def build_system_prompt(context: dict) -> str:
    """Build a system prompt with current UI context, vocabulary, and resolved entities."""
    ...
    # Resolved entities from context resolution
    ...
    # Action schema injection -- gives AI knowledge of available actions
    if skill:
        try:
